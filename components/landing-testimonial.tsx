...
export const LandingTestimonial = () => {
  return (
    <div id="testimonial" className="w-full flex flex-col z-20 bg-bg items-center py-20">
      ...
      <div className="flex flex-row justify-between items-center space-x-6 mt-20">
        <div className="flex flex-col bg-[#161616] border border-[#262424] rounded-[2rem] p-8 w-[385px] h-[265px]">
        ...
        <div className="flex flex-col bg-[#161616] border border-[#242424] rounded-[2rem] p-8 w-[385px] h-[265px]">
          <p className="feature_description mt-1">
            Nova has become my go-to companion. It&apos;s like having a friend
            who&apos;s always there, ready to chat, share a joke, or lend a
            helping hand. The customization is incredible, making Nova feel
