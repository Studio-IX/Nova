...
export const LandingHero = () => {
  ...
  return (
    <div className="w-full flex flex-col items-center px-5 md:px-0 py-12 overflow-x-hidden">
      ...
      <div className="w-fit flex flex-row justify-between items-center px-2 py-2 rounded-full border border-[#8343F3] bg-[#D4BCFE] hover:bg-[#3E281F] transition-all z-10">
        <div className="flex flex-row items-center mr-4">
          <div className="bg-[#8343F3] rounded-full px-3 py-1 mr-2">
            <p className="text-[#8343F3]">New</p>
          </div>
          <p className="">Introducing personal bots</p>
        </div>
